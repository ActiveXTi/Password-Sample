...
A:std::cout << "\a이 파일에 엑세스하기 위해서는 비밀번호 입력이 필요합니다.\n";
    ...
    else if (passnumb == 0)
    {
        ...
        if (r == checknumb)
        {
            ...
            A1:std::cout << "새로운 비밀번호를 입력해 주십시오.\n";;
            std::cin >> code; '\n';
            if (code > 100000 and code < 999999)
        ...
        else if (code > 999999 or code < 100000)
        {
            std::cout << "\a비밀번호는 8자리로만 입력 가능합니다\n";
            goto A1;
        }
        else
        {
    ...
    else if (code < 100000 or code > 999999)
    {
        std::cout << "\a비밀번호는 8자리로만 입력 가능합니다\n\n";
        goto A;
    }
